...
{
    let bitValue = document.getElementsByName('selector')[0].value;
    let block = document.getElementById("block").value;
    let key = document.getElementById("key").value;
    let encrypt = AesCtr.encrypt(block,key,Number(bitValue));
    document.getElementById("Output").value = "Block: "+ block + "\nKey: " + key + "\nCrypted: " + encrypt;
}
...
function DecryptResult()
{
    ...
    let block = document.getElementById("block").value;
    let key = document.getElementById("key").value;
    let decrypt = AesCtr.decrypt(block,key,Number(bitValue));
